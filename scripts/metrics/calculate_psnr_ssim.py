...
if __name__ == '__main__':
    ...
    parser.add_argument('--gt', type=str, default='O:/OneDrive/SrProj_ImgInp/01_MRI_data/Validation', help='Path to gt (Ground-Truth)')
    parser.add_argument('--restored', type=str, default='W:/DONE/RealESRGAN-finetune', help='Path to restored images')
